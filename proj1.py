...
img_bk1 = os.path.join('industry.png')
...
class Sprite(object):  # represents the sprite, not the game
    ...
    def draw(self, surface):
        ...
        #pygame.display.flip()
        # https://edition.cnn.com/2017/10/19/health/pollution-1-in-6-deaths-study/index.html
        showtext("urban industrial air pollution causing large number of")
        showtext2("deaths in lower-middle income countries")
