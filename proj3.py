...
img_bk1 = os.path.join('construction.png')
...
class Sprite(object):  # represents the sprite, not the game
    ...
    def draw(self, surface):
        ...
        #pygame.display.flip()
        #https://www.initiafy.com/blog/how-does-construction-impact-the-environment/
        #https://www.environmentalpollutioncenters.org/construction/
        showtext("Construction sector contributes 23% of air pollution,40%")
        showtext2("of drinking water pollution and 50% of landfill waste")
